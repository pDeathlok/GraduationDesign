...
\author{\IEEEauthorblockN{$Yuqing Lan^1$, $Yang Wang^1$, $Yanni Wang^2$, $Shengwei Yi^1$, $Dan Yu^1$}
\IEEEauthorblockA{School of Computer Science and Engineering, Beihang University, Beijing, $China^1$\\
School of Software, Beihang University, Beijing, $China^2$\\
\{lanyuqing,yangwang,wangyn,yishengwei,yudan\}@buaa.edu.cn}}
